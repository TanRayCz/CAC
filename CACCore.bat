...
set A1=start "" /normal arma3 -skipIntro -noSplash -world=empty -setThreadCharacteristics -connect=%ip1% -name="%ArmaUserName%"
set A2=start "" /normal arma3 -skipIntro -noSplash -world=empty -setThreadCharacteristics -connect=%ip2% -name="%ArmaUserName%"
set A3=start "" /normal arma3 -skipIntro -noSplash -world=empty -setThreadCharacteristics -connect=%ip3% -name="%ArmaUserName%"
set A4=start "" /normal arma3 -skipIntro -noSplash -world=empty -setThreadCharacteristics -connect=%ip4% -name="%ArmaUserName%"
set A5=start "" /normal arma3 -skipIntro -noSplash -world=empty -setThreadCharacteristics -connect=%ip5% -name="%ArmaUserName%"
...
:Antistasi1
set Antistasi1=-mod=gm;%ModPath%@ace;%ModPath%@ace_nouniformrestrictions;%ModPath%@CBA_A3;%ModPath%@Antistasi;%ModPath%@CAC_AE;%ModPath%@AWR;%ModPath%@RealEngine;%ModPath%@EnhancedMovement;%ModPath%@EnhancedMovementRework;%ModPath%@VET_Unflipping;%ModPath%@AdvancedRappelling;%ModPath%@AdvancedUrbanRappelling;%ModPath%@ACEGrenades;%ModPath%@HideAmongTheGrass
