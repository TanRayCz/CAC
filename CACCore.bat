...
:Antistasi1
set Antistasi1=-mod=%ModPath%@CBA_A3;%ModPath%@ace;%ModPath%@ACEComRHSUSAF;%ModPath%@ACEComRHSAFRF;%ModPath%@ACEComRHSGREF;%ModPath%@Antistasi;%ModPath%@CAC_AE;%ModPath%@AWR;%ModPath%@RealEngine;%ModPath%@RHSUSAF;%ModPath%@RHSAFRF;%ModPath%@RHSGREF;%ModPath%@EnhancedMovement;%ModPath%@EnhancedMovementRework;%ModPath%@MfHealAbort;%ModPath%@VET_Unflipping;%ModPath%@AdvancedRappelling;%ModPath%@AdvancedUrbanRappelling
